import { Bytes, ByteArray } from "../common/type";
...
export function testBytesWithByteArray(): void {
  ...
  assert(ByteArray.fromI32LittleEndian(1) == ByteArray.fromI32LittleEndian(1));
  assert(ByteArray.fromI32LittleEndian(1) != ByteArray.fromI32LittleEndian(2));
