...
class SlotRaw {
  ...
  export class Account {
    ...
    public slots: SlotRaw[] = new Array<SlotRaw>(0);
    ...
    // getSlotId(keyI32: i32): i32 {
    //     let test = Bytes.fromI32BigEndian(keyI32).padStart(32)
    //     console.log('getSlotId '+ test.toHexString())
    //     return this.getSlotIdByBytes(test)
    // }
  ...
  export class Block {
      ...
      getAccountId(address: Bytes): i32 {
        ...
        //   console.log(__stack_pointer.toString())
        //   console.log(__data_end.toString())
...
export function zkmain(): void {
    ...
    for (let i = 0; i < blockCount; i++){
        ...
        for (let j = 0; j < accountCount; j++){
            ...
            for (let k = 0; k < slotCount; k++){
                ...
                //TODO: key, if i32 use map?
                account.slots.push(new SlotRaw(key, value, storageProof))
                // console.log('read 1 slot')
            }
    ...
    // TODO: 
    // assertBlockhashChain(blocks (todo), blockhash_latest)
    // let stateRoot = getStateRoot(block.rlpHeader)
    // assertAccountProof(stateRoot, address, rlpNode, accountProof)
    // let storageRoot = getStorageHash(rlpNode)
    // assertStorageProof(storageRoot, key, value, storageProof)
...
// done TODO: add a zkmain for state
// how to use compiler

// done TODO: why failed? with default compile options
// because Map

// done TODO: finish a prove on fake data
// done TODO: finish a prove on real data
